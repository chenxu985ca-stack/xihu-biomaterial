  ...
  return (
    ...
    >
      <div className="font-heading text-3xl font-bold text-graphite-900 sm:text-4xl">
        <span className="tabular-nums">{numericVal}</span>
...
export default function HeroSection() {
  return (
    <section id="home" className="relative flex min-h-screen items-center overflow-hidden bg-white">
      {/* === LAYER 1: Precision engineering grid === */}
      <div
      ...
      {/* === LAYER 2: Major radial glows === */}
      <div className="pointer-events-none absolute -left-32 -top-32 h-[500px] w-[500px] rounded-full bg-gradient-radial-sapphire opacity-[0.06]" />
      <div className="pointer-events-none absolute -bottom-40 right-0 h-[400px] w-[400px] rounded-full bg-gradient-radial-sapphire opacity-[0.04]" />
      ...
      {/* === LAYER 4: Abstract dental arch illustration (right side, desktop only) === */}
      <div
      ...
      {/* === LAYER 5: Tiny floating dots (mobile-friendly) === */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
        <div className="absolute left-[10%] top-[20%] h-1 w-1 rounded-full bg-sapphire-300/20 animate-pulse" />
        <div className="absolute left-[85%] top-[15%] h-1.5 w-1.5 rounded-full bg-warm-bronze/15 animate-pulse" style={{ animationDelay: '1.5s' }} />
        <div className="absolute left-[70%] top-[75%] h-1 w-1 rounded-full bg-sapphire-300/15 animate-pulse" style={{ animationDelay: '0.8s' }} />
        <div className="absolute left-[15%] top-[70%] h-1.5 w-1.5 rounded-full bg-warm-copper/12 animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
